...
import { RiArrowRightSLine, RiCandleFill, RiBookOpenLine, RiGroupLine, RiHeartLine } from "@remixicon/react";
                ...
                <Card className="glass-effect rounded-2xl p-6 md:p-8 shadow-xl border border-blue-100">
                    ...
                    <div className="space-y-4 text-blue-900 leading-relaxed font-body text-right">
                        <div className="flex gap-3">
                            <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-bold">1</span>
                            <p>בחר דפים זמינים מרשימת הדפים</p>
                        </div>
                        <div className="flex gap-3">
                            <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-bold">2</span>
                            <p>למד את הדפים שלקחת בקצב שמתאים לך</p>
                        </div>
                        <div className="flex gap-3">
                            <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-bold">3</span>
                            <p>סמן כהושלם כשסיימת ללמוד</p>
                        </div>
                        <div className="flex gap-3">
                            <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-800 rounded-full flex items-center justify-center text-sm font-bold">4</span>
